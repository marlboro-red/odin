...
> the full validator (30 diagnostics), the templating/context model, the five integration
...
- [Workflow reference](docs/workflow-reference.md) — every YAML field and all 30 `ODIN###`
  diagnostics.
