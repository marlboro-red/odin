...
> the full validator (31 diagnostics), the templating/context model, the five integration
...
- [Workflow reference](docs/workflow-reference.md) — every YAML field and all 31 `ODIN###`
  diagnostics.
